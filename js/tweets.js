  ...
  <div class="tweet-card__grid-container">
      ...
      <div>
          ...
          <div class="tweet-card__icon-container">
              ...
              }" onclick="handleLikingTweet('${tweet[0]}', '${tweet[3]}', ${
    tweet[7]
  });">
                  ...
                  <span class="tweet-card-icon-field-nr heart-text">2k</span>
              </div>
...
async function handleLikingTweet(tweetId, tweeterId, isAlreadyLiked) {
  const userId = document.getElementById('user-id').getAttribute('data-user-id')
  ...
  const res = await (!isAlreadyLiked ? likeTweet(form) : unlikeTweet(form))
  console.log(res)
}
