...
<div class="tweetbar">
    ...
    <div class="tweetbar__content">
        <div class="tweetbar__input-field">
            ...
            <input type="text" id="new-tweet" placeholder="What's happening"
                class="tweetbar__input input-placeholder-large " />
    ...
    <div class="tweet-card">
        <div class="tweet-card__grid-container">
            ...
            <div>
                ...
                <div class="tweet-card__multiple-img-container">
                    <img src="img/tweets/5f89c89d273a67.33817486.jpg" alt="" class="tweet-card__img-mult tweet-card__img-mult-left">
                    <img src="img/tweets/5f89c89d276962.95340539.jpg" alt="" class="tweet-card__img-mult tweet-card__img-mult-right">
                    <img src="img/tweets/5f89c89d27da02.41913429.jpg" alt="" class="tweet-card__img-mult tweet-card__img-mult-left ">
                    ...
                    <ul class="dropdown-primary__list">
                        <li class="dropdown-primary__list-item">
                            <svg viewBox="0 0 24 24" class="dropdown-primary__icon dropdown-primary__icon-delete"">
                                <g>
                                    <path d=" M20.746 5.236h-3.75V4.25c0-1.24-1.01-2.25-2.25-2.25h-5.5c-1.24 0-2.25
                                1.01-2.25 2.25v.986h-3.75c-.414 0-.75.336-.75.75s.336.75.75.75h.368l1.583 13.262c.216
                                1.193 1.31 2.027 2.658 2.027h8.282c1.35 0 2.442-.834 2.664-2.072l1.577-13.217h.368c.414
                                0 .75-.336.75-.75s-.335-.75-.75-.75zM8.496 4.25c0-.413.337-.75.75-.75h5.5c.413 0
                                .75.337.75.75v.986h-7V4.25zm8.822 15.48c-.1.55-.664.795-1.18.795H7.854c-.517
                                0-1.083-.246-1.175-.75L5.126 6.735h13.74L17.32 19.732z"></path>
                                <path
                        ...
                        <li class="dropdown-primary__list-item">
                            <svg class="dropdown-primary__icon" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px"
                                width="528.899px" height="528.899px" viewBox="0 0 528.899 528.899"
                                style="enable-background:new 0 0 528.899 528.899;" xml:space="preserve">
                                <g>
                                    <path
