...
<div class="tweetbar">
    ...
    <div class="tweetbar__content">
        <div class="tweetbar__input-field">
            <input type="text" placeholder="What's happening" class="tweetbar__input" />

            <span class="tweetbar__tagline">
                <svg viewBox="0 0 24 24" class="tweetbar__tagline-img">
                    <g>
                ...
                <span class="tweetbar__tagline-text">Everyone can reply</span></span>
