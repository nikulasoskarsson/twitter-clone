    ...
    <div class="coment-modal__tweet">
        ...
        <div class="comment-modal__form">
            <div class="comment-modal__content">
                ...
                <div>
                    <input type="file" name="images[]" id="upload-tweet-image-modal" " class=" display-hidden"
                        multiple />
                    ...
                    <div class="comment-modal__menu-icon-container">
                        <label for="upload-tweet-image-modal">
                    ...
                    <button class="button-primary-small" id="create-tweet-from-modal">Reply</button>
                </div>
                </div>
            </div>
        </div>
