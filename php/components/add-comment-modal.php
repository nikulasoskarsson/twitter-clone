    ...
    <div class="coment-modal__tweet">
        ...
        <div class="comment-modal__form">
            <div class="comment-modal__content">
                <img src="img/cat.jpg" alt="" class="comment-modal__img img-round-md">
                <div>
                <input type="file" name="images[]" id="comment-modal-images" class="display-hidden" multiple />

                    <div class="comment-modal__input-field">

                        <input autocomplete="off" type="text" name="body"
                            class="comment-modal__input input-placeholder-large" placeholder="Tweet your reply">
                        ...
                        <div class="comment-modal__input-field-border"></div>
                    </div>

                    <div class="comment-modal__menu">
                    <div class="comment-modal__menu-icon-container">
                        <label for="comment-modal-images">
                            <svg viewBox="0 0 24 24" class="icon-25px-primary">
                                <g>
                    ...
                    <button class="button-primary-small" id="create-tweet-from-modal" onclick="handleCommentingOnTweet()">Reply</button>
                </div>
                </div>
            </div>
        </div>
